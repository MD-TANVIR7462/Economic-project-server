...
const NAvbar = () => {
   const { CreatUSerEmail, user, SignInUSer, signOutUSer, updateUser, loading, googleCreatUSer } = useContext(AuthContext)
   ...
   const navOptions = (
      ...
      <>
         ...
         <li className='text-xl font-semibold text-[#168a73] '><Link to={'/'}>Blog</Link></li>
   ...
   return (
      <div className={`navbar   ${isScrolled ? "bg-[#e3e6f3] shadow-md" : "bg-none"} md:py-6 md:px-16 fixed top-0 z-10`}>
         ...
         <div className="navbar-end ">
...

            {
               ...
               user && <div className="dropdown dropdown-end z-10">
                  ...
                  <ul tabIndex={0} className="menu menu-xs md:menu-sm dropdown-content mt-3 z-[1] p-2 shadow  rounded-box w-40  bg-purple-200 md:w-52">
                     <li>
                     ...
                     <li><span onClick={logout} className='font-semibold'>Logout</span></li>
            ...
            {!user && !loading && <button className="btn btn-circle  btn-ghost text-[#168a73]  md:border-2 md:border-[#168a73] text-3xl md:mr-2 " onClick={openModal} ><BsBoxArrowInRight></BsBoxArrowInRight></button>
            }

            <div className="dropdown dropdown-end z-10">
               <label tabIndex={0} className="btn btn-ghost btn-circle mr-2 md:mr-4">
                  <div className="indicator">
                     <svg xmlns="http://www.w3.org/2000/svg" className="md:h-7 h-6 w-6 md:w-7 text-[#168a73]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
                     <span className=" bg-red-600 text-white rounded-full px-1 py-1 indicator-item">8</span>
                  </div>
               </label>
               <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content  w-36 md:w-52 bg-purple-200 shadow">
                  <div className="card-body">
                     <span className="font-bold text-md">8 Items</span>
                     <span className="text-info">Subtotal: $999</span>
                     <div className="card-actions">
                        <button className="btn btn-sm  btn-primary btn-block md:p-2">View cart</button>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className={`modal ${isOpen ? 'modal-open' : ''}`}>
               <div className="modal-box ">
                  ...
                  <span className='flex justify-between items-center'>
                     ...
                     <button className="btn btn-square hover:bg-[#11715e]  bg-[#168a73] text-white" onClick={closeModal}>
                        X
                     </button>
                  </span>
                  <form onSubmit={login} className="md:p-[2%]">
                     ...
                     <div className="form-control mt-6">
                        <button class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-[#11715e] rounded-full shadow-md group">
                           ...
                           <span class="absolute flex items-center justify-center w-full h-full text-[#11715e] transition-all duration-300 transform group-hover:translate-x-full ease">Login</span>
                  ...
                  <div className="mt-4 flex flex-col items-center ">
                     ...
                     <button onClick={LoginWithGoogle} className='btn btn-circle hover:bg-[#11715e]  bg-[#168a73] px-4 text-center text-white '><FaGoogle></FaGoogle></button>
                  </div>
               </div>
            </div>
         }
            ...
            resiterModal && <div className={`modal ${resiterModal ? 'modal-open' : ''}`}>
               <div className="modal-box ">
                  ...
                  <span className='flex justify-between items-center'>
                     ...
                     <button className="btn btn-square hover:bg-[#0d5345]  bg-[#11715e] text-white" onClick={closeResisterModal}>
                        X
                     </button>
                  </span>
                  <form className="md:p-[2%]" onSubmit={handleResister}>
                     ...
                     <div className="form-control mt-6">
                        <button class="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-[#11715e] transition duration-300 ease-out border-2 border-[#11715e] rounded-full shadow-md group">
                           ...
                           <span class="absolute flex items-center justify-center w-full h-full text-[#11715e]transition-all duration-300 transform group-hover:translate-x-full ease">Resister</span>
                           <span class="relative invisible">Resister</span>
                        </button>
                     </div>
                  </form>
                  {
                     Error && <p className=' text-sm md:text-md text-center text-red-500'>{Error}</p>
                  }
               </div>
            </div>
         }
